...
class CartItem {
    ...
    public double getSubtotal() {
        return product.price * quantity; // Subtotal in INR
    }
}

class Cart {
    private ArrayList cartItems = new ArrayList<>();
    private static final double DELIVERY_CHARGES = 78.0; // In INR
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (currencyChoice) {
                case 1:
                    currency = "INR";
                    exchangeRate = 1.0; // INR to INR
                    break;
                case 2:
                    currency = "USD";
                    exchangeRate = 1.0 / 87.00; // INR to USD (1 USD = 87 INR)
                    break;
                case 3:
                    currency = "EUR";
                    exchangeRate = 1.0 / 94.50; // INR to EUR (1 EUR = 94.50 INR)
                    break;
                default:
                    System.out.println("Invalid input! Try again.");
                    currency = null;
